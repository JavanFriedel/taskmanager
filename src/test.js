...
function newProject(title, dueDate, priority, color, tasks) {
  const project = createProject(title, dueDate, priority, color, tasks);
...
// Injecting Test Data
const testTask = createTaskObj('Task1', 'This is test', 'X', 'X', 'X');
const testTask2 = createTaskObj('Task2', 'This is test', 'X', 'X', 'X');
const testTask3 = createTaskObj('Task3', 'This is test', 'X', 'X', 'X');
